declare namespace overwolf {
  ...
  namespace media {
     ...
     * @param callback A function called after the screenshot was taken.
     */
    function takeWindowsScreenshotByHandle(windowHandle: number, postMediaEvent: boolean, targetFolder: string, callback: () => void): void
     ...
     * @param callback A function called after the screenshot was taken.
     */
    function takeWindowsScreenshotByHandle(windowHandle: number, postMediaEvent: boolean, callback: () => void): void
     ...
     * @param callback A function called after the screenshot was taken.
     */
    function takeWindowsScreenshotByName(windowName: string, postMediaEvent: boolean, targetFolder: string, callback: () => void): void
     ...
     * @param callback A function called after the screenshot was taken.
     */
    function takeWindowsScreenshotByName(windowName: string, postMediaEvent: boolean, callback: () => void): void
     ...
     * @param callback A function called after the screenshot was taken.
     */
    function getScreenshotUrl(screenshotParams: any, callback: (result: any) => void): void
     ...
     */
    function shareImage(image: any, description: string, callback: () => void): void
     ...
     */
    function postMediaEvent(mediaType: any, jsonInfo: any, callback: () => void): void
  ...
  "summary": "See overwolf.media.replays"
    ...
    namespace audio {
       ...
       * @param callback A callback function which will be called with the status of the stop request.
       */
      function setVolumeById(id: string, volume: number, callback: () => void): void
    ...
    namespace videos {
       ...
       */
      function createVideoComposition(sourceVideoUrl: string, segments: any, callback: () => void): void
       ...
       * @param callback A callback function which will be called with the status of the request and the url to the target video.
       */
      function createVideoCompositionFiles(files: string, outputFile: string, callback: () => void): void
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function deleteOldVideos(keepNewestXGbs: number, callback: () => void): void
    ...
    namespace replays {
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function capture(pastDuration: number, futureDuration: number, captureFinishedCallback: () => void, callback: () => void): void
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function capture(replayType: any, pastDuration: number, futureDuration: number, captureFinishedCallback: () => void, callback: () => void): void
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function startCapture(replayType: any, pastDuration: number, callback: () => void): void
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function stopCapture(replayType: any, replayId: string, callback: () => void): void
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function setReplaysSubFolder(replayType: any, subFolderName: string, callback: () => void): void
 ...
 "\r\n or an error message if not:\r\n "
  ...
  namespace windows {
     ...
     */
    function obtainDeclaredWindow(windowName: string, callback: (response: any) => void): void
     ...
     * @param callback Called with the status of the request
     */
    function sendMessage(windowId: string, messageId: string, messageContent: any, callback: () => void): void
     ...
     * @param callback Called with the status of the request
     */
    function setWindowStyle(windowId: string, style: any, callback: () => void): void
     ...
     * @param callback Called with the status of the request
     */
    function removeWindowStyle(windowId: string, style: any, callback: () => void): void
     ...
     * @param callback 
     */
    function setDesktopOnly(windowId: string, shouldBeDesktopOnly: boolean, callback: () => void): void
     ...
     * @param callback 
     */
    function setRestoreAnimationsEnabled(windowId: string, shouldEnableAnimations: boolean, callback: () => void): void
     ...
     * @param callback 
     */
    function setTopmost(windowId: string, shouldBeTopmost: boolean, callback: () => void): void
    ...
    namespace mediaPlayerElement {
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function create(x: number, y: number, width: number, height: number, callback: () => void): void
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function setBounds(id: number, x: number, y: number, width: number, height: number, callback: () => void): void
       ...
       */
      function setVideo(id: number, videoUrl: string, callback: () => void): void
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function setTobiiLayer(id: number, param: any, callback: () => void): void
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function setVolume(id: number, volume: number, callback: () => void): void
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function setPlaybackSpeed(id: number, speedRatio: number, callback: () => void): void
       ...
       * @param callback A callback function which will be called with the status of the request.
       */
      function setStretchMode(id: number, stretchMode: any, callback: () => void): void
  ...
  "summary": "[\r\n \"\\r\\n Fired when the rendering frame rate of the currently injected game changes dramatically:\\r\\n \",\r\n \"\\r\\n The \\\"fps_status\\\" field can be \\\"None\\\", \\\"Stable\\\", \\\"Drop\\\" and \\\"Increase\\\".\\r\\n \"\r\n]"
    ...
    namespace launchers {
       ...
       */
      function getRunningLaunchersInfo(callback: (result: GetRunningLaunchersInfoResult) => void): void
  ...
  "summary": "Fired when the launcher info is updated, including game name, game running, game terminated, game changing focus, etc. Passes a ILauncherInfo object."
    ...
    namespace events {
       ...
       */
      function setRequiredFeatures(features: string[], callback: (result: any) => void): void
    ...
    namespace inputTracking {
       ...
       * @param callback A callback with the activity information.
       */
      function getMatchActivityInformation(callback: () => void): void
  ...
  namespace logitech {
    ...
    namespace arx {
       ...
       */
      function init(identifier: string, friendlyName: string, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function addFileAs(fileUrl: string, fileName: string, mimeType: string, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function addContentAs(base64Content: string, fileName: string, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function addContentAs(content: number[], fileName: string, mimeType: string, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function addUtf8StringAs(stringContent: string, fileName: string, mimeType: string, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function addImageFromBitmap(bitmap: number[], width: number, height: number, fileName: string, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function setTagPropertyById(tagId: string, prop: string, newValue: string, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function setTagsPropertyByClass(tagsClass: string, prop: string, newValue: string, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function setTagContentById(tagId: string, newContent: string, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function setTagsContentByClass(tagsClass: string, newContent: string, callback: () => void): void
  ...
  "summary": "An Arx event send with a Logitech Arx Event Data object."
    ...
    namespace led {
       ...
       * @param callback A callback with the result of the request.
       */
      function setTargetDevice(targetDevices: any[], callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function setLighting(redPercentage: number, greenPercentage: number, bluePercentage: number, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function flashLighting(redPercentage: number, greenPercentage: number, bluePercentage: number, milliSecondsDuration: number, milliSecondsInterval: number, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function pulseLighting(redPercentage: number, greenPercentage: number, bluePercentage: number, milliSecondsDuration: number, milliSecondsInterval: number, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function setLightingFromBitmap(bitmapUrl: string, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function setLightingFromBitmap(bitmap: number[], callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function setLightingForKeyWithScanCode(keyCode: number, redPercentage: number, greenPercentage: number, bluePercentage: number, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function setLightingForKeyWithHidCode(keyCode: number, redPercentage: number, greenPercentage: number, bluePercentage: number, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function setLightingForKeyWithQuartzCode(keyCode: number, redPercentage: number, greenPercentage: number, bluePercentage: number, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function setLightingForKeyWithKeyName(keyName: any, redPercentage: number, greenPercentage: number, bluePercentage: number, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function flashSingleKey(keyName: any, redPercentage: number, greenPercentage: number, bluePercentage: number, milliSecondsDuration: number, milliSecondsInterval: number, callback: () => void): void
       ...
       * @param callback A callback with the result of the request.
       */
      function pulseSingleKey(keyName: any, startRedPercentage: number, startGreenPercentage: number, startBluePercentage: number, finishRedPercentage: number, finishGreenPercentage: number, finishBluePercentage: number, milliSecondsDuration: number, isInfinite: boolean, callback: () => void): void
 ...
 "\r\n or an error message if not:\r\n "
     ...
     */
    function changeVolume(streamId: number, audioOptions: any, callback: () => void): void
     ...
     */
    function getWindowStreamingMode(windowId: string, callback: () => void): void
     ...
     */
    function setWindowStreamingMode(windowId: string, streamingMode: any, callback: () => void): void
     ...
     * @param callback A function called after streaming mode was set indicating success, or error in case of an error.
     */
    function setWindowObsStreamingMode(windowId: string, obsStreamingMode: any, callback: () => void): void
     ...
     */
    function setBRBImage(streamId: number, image: any, backgroundColor: string, callback: () => void): void
     ...
     * @param callback A callback function to call with success or failure indication.
     */
    function updateStreamingDesktopOptions(streamId: number, newOptions: any, mouseCursorStreamingMethod: any, callback: () => void): void
 ...
 "\r\n or an error message if not:\r\n "
  ...
  namespace extensions {
     ...
     */
    function registerInfo(id: string, eventsCallback: () => void, callback: () => void): void
  ...
  namespace utils {
     ...
     */
    function getSystemInformation(callback: () => void): void
     ...
     * @param callback A callback with the status of the request.
     */
    function simulateMouseClick(x: number, y: number, callback: () => void): void
  ...
  "summary": "Registers a callback for a given hotkey action."
     ...
     * @param callback 
     */
    function getCurrentOverwolfLanguage(callback: () => void): void
     ...
     */
    function setOverwolfScreenshotsFolder(path: string, callback: () => void): void
     ...
     * @param callback 
     */
    function setVideoCaptureSettings(resolutionSettings: any, fps: number, callback: () => void): void
     ...
     * @param callback 
     */
    function setAudioCaptureSettings(enableSound: boolean, enableMicrophone: boolean, callback: () => void): void
    ...
    namespace games {
       ...
       * @param callback 
       */
      function getOverlayEnabled(gameClassId: number, callback: () => void): void
       ...
       * @param callback 
       */
      function getAutoLaunchEnabled(gameClassId: number, callback: () => void): void
